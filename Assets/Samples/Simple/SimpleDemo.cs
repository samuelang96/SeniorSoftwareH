...
public class SimpleDemo : MonoBehaviour {
	...
	void Start () {
		rm = GameObject.Find ("RequestsManager").GetComponent<RequestsManager> (); 
	...
	public void ClickStart()
	{
		...
		if (BarcodeScanner == null) {
			TextHeader.text = "Camera Not Found :(";
			return;
		} else {
			TextHeader.text = "please scan a barcode to begin :)";
		}
